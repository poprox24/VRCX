...
<script setup>
    ...
    import { userImage } from '../shared/utils/user';
    ...
    const isUserReady = computed(() => Boolean(currentUser.value?.id));
    const userAvatar = computed(() => userImage(currentUser.value, true, '128'));
