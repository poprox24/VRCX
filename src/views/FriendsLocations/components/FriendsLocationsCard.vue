...
<style scoped>
    ...
    .friend-card__status-dot--online {
        ...
        box-shadow: 0 0 calc(8px * var(--card-scale)) color-mix(in oklch, var(--el-color-success) 40%, transparent);
    }

    .friend-card__status-dot--join {
        background: var(--el-color-primary);
        box-shadow: 0 0 calc(8px * var(--card-scale)) color-mix(in oklch, var(--el-color-primary) 40%, transparent);
    }

    .friend-card__status-dot--busy {
        background: var(--el-color-danger);
        box-shadow: 0 0 calc(8px * var(--card-scale)) color-mix(in oklch, var(--el-color-danger) 40%, transparent);
    }

    .friend-card__status-dot--ask {
        background: var(--el-color-warning);
        box-shadow: 0 0 calc(8px * var(--card-scale)) color-mix(in oklch, var(--el-color-warning) 40%, transparent);
    }
