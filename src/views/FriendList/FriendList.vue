    ...
    <div class="x-container" ref="friendsListRef">
        <div>
            <div style="display: flex; align-items: center; justify-content: space-between">
                ...
                <div class="flex items-center">
                    ...
                    <div class="flex items-center mr-10">
                        <span class="name mr-10 text-13">{{ t('view.friend_list.bulk_unfriend') }}</span>
                        <el-switch
            ...
            <DataTable
                ...
                <el-table-column :label="t('table.friendList.avatar')" width="90" prop="photo" fixed="left">
                    <template #default="{ row }">
                        <div class="flex items-center">
                ...
                <el-table-column :label="t('table.friendList.unfriend')" width="100" align="center" fixed="right">
                    <template #default="{ row }">
                        <i
